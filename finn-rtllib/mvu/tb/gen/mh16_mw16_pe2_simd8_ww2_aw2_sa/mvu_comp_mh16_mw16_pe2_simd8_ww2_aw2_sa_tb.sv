 ...
 *   2         - Weight Width
 *   2         - Activation Width
 *   16 - Accumulator Width
 *   1 - Signed Activations (0 or 1)
 *   1 - Compressor Pipeline Depth
 *   mh16_mw16_pe2_simd8_ww2_aw2_sa      - Configuration label
 *****************************************************************************/

module mvu_comp_mh16_mw16_pe2_simd8_ww2_aw2_sa_tb;

	localparam int unsigned  ROUNDS = 17;

	localparam int unsigned  MH   = 16;
	localparam int unsigned  MW   = 16;
	localparam int unsigned  PE   = 2;
	localparam int unsigned  SIMD = 8;
	localparam int unsigned  WEIGHT_WIDTH     = 2;
	localparam int unsigned  ACTIVATION_WIDTH = 2;
	localparam int unsigned  ACCU_WIDTH       = 16;
	localparam bit  SIGNED_ACTIVATIONS = 1;
	localparam int unsigned  COMP_PIPELINE_DEPTH = 1;
...
endmodule : mvu_comp_mh16_mw16_pe2_simd8_ww2_aw2_sa_tb

 ...
 *   0 - Signed Activations (0 or 1)
 *   1 - Compressor Pipeline Depth
 *   mh16_mw8_pe4_simd8_ww1_aw1      - Configuration label
 *****************************************************************************/

module mvu_comp_mh16_mw8_pe4_simd8_ww1_aw1_tb;
	...
	localparam int unsigned  WEIGHT_WIDTH     = 1;
	localparam int unsigned  ACTIVATION_WIDTH = 1;
...
endmodule : mvu_comp_mh16_mw8_pe4_simd8_ww1_aw1_tb

...
from compressor_python.main import generate_compressor
from compressor_python.target import Versal, SevenSeries
from compressor_python.utils.shape import Shape
